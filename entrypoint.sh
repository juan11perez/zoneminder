...
# and thus should be compatible with major Linux distros. https://github.com/ZoneMinder/zmdockerfiles/blob/master/utils/entrypoint.sh
...
###################################################################################################
#copied from https://github.com/dlandon/zoneminder/blob/master/init/40_firstrun.sh#################
...
# Added to allow file changes in dir
chmod -R 777 /config
###################################################################################################
###################################################################################################
