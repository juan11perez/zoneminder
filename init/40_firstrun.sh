...
if [ -f /etc/zm/zmeventnotification.ini ]; then
	...
	cp /etc/zm/zmeventnotification.ini /config/zmeventnotification.ini.default
	if [ ! -f /config/zmeventnotification.ini ]; then
		mv /etc/zm/zmeventnotification.ini /config/zmeventnotification.ini
	else
		rm -rf /etc/zm/zmeventnotification.ini
	fi
else
...
if [ -f /etc/zm/secrets.ini ]; then
	...
	cp /etc/zm/secrets.ini /config/secrets.ini.default
	if [ ! -f /config/secrets.ini ]; then
		mv /etc/zm/secrets.ini /config/secrets.ini
	else
		rm -rf /etc/zm/secrets.ini
	fi
else
...
if [ -f /root/opencv.sh ]; then
	echo "Moving opencv.sh"
	cp /root/opencv.sh /config/opencv/opencv.sh.default
	if [ ! -f /config/opencv/opencv.sh ]; then
		mv /root/opencv.sh /config/opencv/opencv.sh
	else
		rm -rf /root/opencv.sh
	fi
else
...
if [ -f /root/debug_opencv.sh ]; then
	echo "Moving debug_opencv.sh"
	mv /root/debug_opencv.sh /config/opencv/debug_opencv.sh
else
...
if [ -f /etc/zm/zmeventnotification.pl ]; then
	...
	mv /etc/zm/zmeventnotification.pl /usr/bin
...
# if [ -f /var/lib/zmeventnotification/bin/pushapi_plugins/pushapi_pushover.py ]; then
# 	echo "Moving the pushover api"
# 	# mkdir -p /var/lib/zmeventnotification/bin/
# 	mv /var/lib/zmeventnotification/bin/pushapi_plugins/pushapi_pushover.py /var/lib/zmeventnotification/bin/
...
if [ -f /etc/zm/es_rules.json ]; then
	...
	cp /etc/zm/es_rules.json /config/es_rules.json.default
	if [ ! -f /config/es_rules.json ]; then
		mv /etc/zm/es_rules.json /config/es_rules.json
	else
...
if [ -f /var/lib/zmeventnotification/bin/config_upgrade.py ]; then
	echo "Moving config_upgrade.py"
	mv /var/lib/zmeventnotification/bin/config_upgrade.py /config/hook/config_upgrade.py
...
if [ -f /var/lib/zmeventnotification/bin/zm_event_start.sh ]; then
	echo "Moving zm_event_start.sh"
	mv /var/lib/zmeventnotification/bin/zm_event_start.sh /config/hook/zm_event_start.sh
else
	echo "File zm_event_start.sh already moved"
fi

# Handle the zm_event_end.sh file
if [ -f /var/lib/zmeventnotification/bin/zm_event_end.sh ]; then
	echo "Moving zm_event_end.sh"
	mv /var/lib/zmeventnotification/bin/zm_event_end.sh /config/hook/zm_event_end.sh
else
	echo "File zm_event_end.sh already moved"
fi

# Handle the zm_detect.py file
if [ -f /var/lib/zmeventnotification/bin/zm_detect.py ]; then
	echo "Moving zm_detect.py"
	mv /var/lib/zmeventnotification/bin/zm_detect.py /config/hook/zm_detect.py
else
	echo "File zm_detect.py already moved"
fi

# Handle the zm_detect_old.py file
if [ -f /var/lib/zmeventnotification/bin/zm_detect_old.py ]; then
	echo "Moving zm_detect_old.py"
	mv /var/lib/zmeventnotification/bin/zm_detect_old.py /config/hook/zm_detect_old.py
else
	echo "File zm_detect_old.py already moved"
fi

# Handle the zm_train_faces.py file
if [ -f /var/lib/zmeventnotification/bin/zm_train_faces.py ]; then
	echo "Moving zm_train_faces.py"
	mv /var/lib/zmeventnotification/bin/zm_train_faces.py /config/hook/zm_train_faces.py
else
...
if [ -f /var/lib/zmeventnotification/models/coral_edgetpu/coco_indexed.names ]; then
	...
	echo "coco_indexed.names already moved"
fi
...
mv /var/lib/zmeventnotification/bin/setup.py /root/setup.py 2>/dev/null
